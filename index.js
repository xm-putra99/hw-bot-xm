...
if (isBan) return reply(mess.ban)
       ...
       case 'ssweb':
             ...
             await Haikal.sendMessage(from, ini_buffer, image, { quoted: kal })
             break
case 'doujindesu':
             ...
             Haikal.sendMessage(from, buffer, image, {caption: xixixai, quoted: kal})
             } catch (e) {
             console.log(e)
             reply(String(e))
}
      ...
      case 'anime':
             ...
             await Haikal.sendMessage(from, thumbnail, image, { quoted: kal, caption: ini_txt })
             break
      case 'kusonime':
             if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
             reply(mess.wait)
             ...
             await Haikal.sendMessage(from, ini_buffer, image, { quoted: kal, caption: ini_txt })
             break
       case 'otakudesu':
              if (args.length == 0) return reply(`Example: ${prefix + command} Gotoubun No Hanayome`)
              reply(mess.wait)
       ...
       case 'wallnime':
              ...
              Haikal.sendMessage(from, gambar, image, { quoted: kal, thumbnail: Buffer.alloc(0) })
})
              break
       
       case 'hentasex':
              getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/hentai?apikey=${setting.lolkey}`).then((gambar) => {
              Haikal.sendMessage(from, gambar, image, { quoted: kal })
}) 
              break
        case 'otakuongoing':              
               o = await onGoing()
               ...
               Haikal.sendMessage(from, buff, image, {quoted: kal, caption: ot})
               break
case 'randombokep':
              bokep = body.slice(1)
              ...
              break
                case 'xnxx':
                    ...
                    Haikal.sendMessage(from, thumbnail, image, { quoted: kal, caption: ini_txt })
                    break
        case 'xnxxsearch':
